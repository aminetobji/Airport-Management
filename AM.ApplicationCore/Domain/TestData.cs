namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Flight flight2 = new Flight { Departure = "Madrid", AirlineLogo = "Tunisair",FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
